export const dataSoal = [
  {
    ...
    descriptionSoal: `
      Diketahui input berisi array dengan panjang genap dan berisi angka (diurutkan terlebih dahulu). Buatlah grup dari angka-angka tersebut menjadi berpasangan seperti (a1,b1), (a2,b2),...(an,bn) yang membuat jumlah dari angka terkecil pasangan-pasangan tersebut (ai,bi) untuk semua i dari 1. 
  ...
  },
  {
    ...
    descriptionSoal: `
      Diketahui inputan berupa string, tugas kamu adalah mencari berapa banyak substring palindromik dari string tersebut. Kata Palindromik adalah kata yang di bolak balik memiliki susunan / pengucapan yang sama.
      Contoh:
  ...
  },
  {
    ...
    descriptionSoal: `
      Diketahui input berupa string angka, output berupa semua kemungkinan pasangan huruf/angka dari inputan tersebut.
      0 = ' '
      1 = ' '
      2 = a,b,c
      3 = d,e,f
